...
function App({ components, setComponents}) {
  ...
  // const[storedata,setStoreData] =useState({Logic:Logic})
  // pagination====>
  ...
  const [postsData, setPostsData] = useState([
    {
      id: uuid(),
      question: { type: "Boolean", title: "hubspot is good or bad?" },
    },
    {
      id: uuid(),
      question: { type: "Boolean", title: "Marketo is good or bad?" },
    },
  ]);
  ...
  return (
    <>
      ...
      <Container fluid>
        <Row>
          <div className="side-circle col-md-2 col-lg-2">
        ...
        {/*off canvas part start ================================================*/}
          <div className="canvas col-lg-2 col-md-2">
              ...
              <Offcanvas.Body>
                ...
                <div className="input">
                  <form onSubmit={handleData}>
                    <Row>
                      <div>
                        <p>Double tap to select Question</p>
                      </div>
                      {/* Bolean questions start ================================*/}
                      <div className="bool">
                        <Col md={12} lg={12}>
                          <h4 className="bool">Boolean Questions</h4>
